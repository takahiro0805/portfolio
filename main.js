var worksinfo = [
  {
    ...
    "text": [
      ...
      "",
      "",
      "実際にユーザーが使用するシーンを想定した。様々なプランをシームレスに比較・検討する場合や、いろいろなプランに触れて欲しいため、このような仕様にした。"
    ],
    "photo_num": 6,
    "movie_num": 1,
    "movie_url":[
      '<iframe class="movie" src="https://www.youtube.com/embed/xbgmJFeERJg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',''],
    "info_data": [
      1,1,2,1,1,1
    ]
  },
    ...
    },
      {
      ...
      },
        {
        ...
        },
          {
            ...
            "date": "2019/06",
            "copy": "毎朝見たくなる天気予報アプリ",
            "overview": "PORTは、毎朝天気予報をチェックすることと同時にその日の気候に合った服装を提案してくれるアプリケーション。また、ユーザーにあった服装を提案するために、日々服装を記録することによりその人の体感にあった服装を提案することができる。",
            "job": "UI/UXデザイン",
            "tools": "Illustrator/sketch",
            "title": [
              "ターゲットと課題",
            ...
            "text": [
              "天気は毎日気にするものだが、その天気にあった服装は人それぞれだ。今日の天気と、自分の体感温度と合った服装を提案するために、日々服装とその体感を記録することにより、そのユーザーによりあった服装を提案してくれるように設計した。",
              "毎朝、朝日を見るようにこのアプリをチェックしてほしいという思いを込めて『PORT』と名付けた。PORTは港という意味で、このアプリを通して、朝日としての天気と服装をチェックする。また、ロゴに関しては、港から見て、昇ってくる太陽をモチーフにデザインした。"
            ],
            "photo_num": 4,
            "info_data":[
              1,1,2
